...
from app.agent.tools.symptoms import check_symptoms
...
@pytest.mark.asyncio
async def test_check_symptoms_gets_full_detail_and_checklist(monkeypatch):
    verdict = {
...
@pytest.mark.asyncio
async def test_check_symptoms_never_hits_a_quota_regardless_of_call_volume(monkeypatch):
